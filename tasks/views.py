...
other_vars=['m','a','c','m','t','v','V','p'] #опять делаю по-своему и никого не слушаю да! 
def taskss(request):
    if request.method == 'POST':
        ...
        return render(request, 'tasks.html', {'tasks': tasks})
#искренне извиняюсь за мусор и бессмысленные комменты обещаю что эта ситуация будет повторяться по мере возможности
